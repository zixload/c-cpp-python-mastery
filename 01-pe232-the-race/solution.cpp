...
int main() {
    static std::array<std::array<double, TARGET>, TARGET> f{};
    static std::array<std::array<double, TARGET>, TARGET> h{};
    ...
    std::cout << std::fixed << std::setprecision(8) << f[0][0] << std::endl;
    return 0;
}
